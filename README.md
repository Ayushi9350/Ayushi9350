...
<img src="https://img.shields.io/github/stars/Ayushi9350?label=STARS&style=for-the-badge&color=yellow"/>

<br><br>

[![Portfolio](https://img.shields.io/badge/PORTFOLIO-VISIT-8A2BE2?style=for-the-badge)](https://ayushiportfoliofinal.vercel.app/)
[![LinkedIn](https://img.shields.io/badge/LINKEDIN-CONNECT-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/mangroliya-ayushi-489a612b1)
...
Aspiring Computer Engineering student passionate about building intelligent systems and beautiful digital experiences. B.Tech Computer Engineering student at **LDRP Institute of Technology & Research**, Gandhinagar (2023–2027) with a CPI of **8.14**.

Currently working as a **Python Django Full Stack Developer Intern** at Skyway IT Solution, building a real-world singer management platform (AnantKala). I love crafting production-ready web apps with Django, exploring AI/ML models, and solving real problems with data-driven solutions.

### 🚀 Open To
- 🤖 AI/ML Internships
- 🖥️ Backend Development Opportunities (Django)
...
|---|---|---|
| 🚗 **Car Rental Management System** | Web-based system to manage car bookings & availability — browse, book, and rent cars online with a database backend | `Django` `Python` |
| 🌾 **Crop Price Prediction** | ML model built in Google Colab to predict crop prices using historical agricultural data, comparing Random Forest & XGBoost | `Machine Learning` `Python` |
